...
public class UserDao implements iUserDao {
    ...
    public int modify(Employee user) {
        int rtn=0;
        try{
            String sql = "update employee set emp_name= '"+user.getName()+"'"+",access="+user.getAccess()+
                    " , emp_tel_num='"+user.getTel()+"',"+"password='"+user.getPassword()+"',emp_sale_money="+user.getSaleMoney()+", password= '"+user.getPassword()+"' "
